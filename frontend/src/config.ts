export default {
  ...
  AUTHORIZED: {
    ...
    SU: [
      ...
      'create_mail-template', 'buildings', 'rounds', 'students', 'syndicusen', 'mailtemplates', 'mail-template',
    ...
    AD: [
      ...
      'studenttemplate', 'users', 'studenttemplates', 'add_studenttemplate', 'ronde_dagplanningen', 'dagplanning_edit', 'dagplanning_add',
      'create_mail-template', 'buildings', 'rounds', 'students', 'syndicusen', 'mailtemplates', 'mail-template', 'admin_info_building',
