export default {
  ...
  AUTHORIZED: {
    ...
    SU: ['admin_home', 'dagplanning', 'account', 'unauthorized', 'home', 'create_building', 'create_location',
      'create_round', 'create_mail-template', 'buildings', 'rounds', 'students',
      'syndicusen', 'mailtemplates', 'admin_info_user', 'admin_edit_user', 'admin_user_register'],
    AD: ['admin_home', 'account', 'unauthorized', 'home', 'create_building', 'admin_building', 'create_location',
      'create_round', 'create_mail-template', 'buildings', 'rounds', 'students',
      'syndicusen', 'mailtemplates', 'admin_info_user', 'admin_edit_user', 'admin_user_register']
  }
};
