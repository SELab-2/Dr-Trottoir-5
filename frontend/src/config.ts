export default {
  ...
  AUTHORIZED: {
    ...
    ST: ['student_home', 'dagplanning', 'account', 'unauthorized', 'home', 'student_post_edit', 'student_post', 'student_post_view', 'building_info', 'building_student'],
    ...
    AD: ['admin_home', 'account', 'unauthorized', 'home', 'create_building', 'admin_building', 'create_location', 'create_round', 'create_mail-template', 'buildings', 'rounds', 'students', 'syndicusen', 'mailtemplates', 'syndicus_create', 'syndicus_adjust']
  }
};
